# -*- coding: utf-8 -*-
"""TAMIL bert-base-cased-Class weight- Multilingual hasoc2021.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UfuV6GdGRv_KOstMo89_gWBhj4HO-Kri
"""
...
Mal_train=pd.read_csv("tamil_sentiment_full_train (1).tsv" , sep='\t')
Mal_Dev=pd.read_csv("tamil_sentiment_full_dev (1).tsv" , sep='\t')
...
model = ClassificationModel(
    ...
    num_labels=5,
    weight=[1.77393035, 1.66967923, 0.35531639, 4.27786443, 1.26709311],
